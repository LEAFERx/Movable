...
use diem_types::vm_error::{StatusCode, VMStatus};
...
// TODO: activate the batch feature in the import of diem-crypto in the
// present crate, once https://github.com/diem/diem/issues/3567 is fixed
...
fn sanity_check(
    ...
    if bitmap_count_ones == 0 {
        ...
        return Err(NativeResult::err(
            cost,
            PartialVMError::new(StatusCode::NATIVE_FUNCTION_ERROR).with_sub_status(ZERO_BITMAP_FAILURE),
        ));
    }
